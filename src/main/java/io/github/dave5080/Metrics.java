...
public class Metrics {
    ...
    private JSONObject getServerData() {
        ...
        try {
            ...
            playerAmount = onlinePlayersMethod.getReturnType().equals(Collection.class)?((Collection)onlinePlayersMethod.invoke(Bukkit.getServer(), new Object[0])).size():((Player[])((Player[])onlinePlayersMethod.invoke(Bukkit.getServer(), new Object[0]))).length;
